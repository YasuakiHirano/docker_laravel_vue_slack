<template>
  <div class="bg-gray-200 border-gray-500 rounded-md border flex pt-1 pb-1 justify-end">
    <cancel-border-icon v-if="isCancel" class="ml-3" @click="$emit('event:clickCancelIcon')" />
